package xyz.alviksar.orchidarium.user;
...
public class OrchidIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "xyz.alviksar.orchidarium.user.action.FOO";
    private static final String ACTION_BAZ = "xyz.alviksar.orchidarium.user.action.BAZ";
